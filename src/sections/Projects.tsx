...
import absenceSyncPage from "@/assets/images/absence-sync-page.png";
...
const portfolioProjects = [
  ...
  },
  {
    ...
    image: absenceSyncPage,
  },
];

export const ProjectsSection = () => {
  return (
    <section id="projects" className="pb-16 lg:py-24 scroll-mt-24">
      <div className="container">
        <SectionHeader eyebrow="Real-world Results" title="Featured Projects" description="See how I transformed concepts into efficient solutions." />
          ...
          {portfolioProjects.map((project, projectIndex) => (
            <Card
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                ...
                gap-2 font-bold uppercase tracking-widest 
